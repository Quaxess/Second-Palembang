...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a
                            href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your Favorite Product</a></li>
        ...
        ?>
        <section class="inner-page-hero bg-image" data-image-src="images/hal6.png">
            <div class="profile">
                <div class="container">
                    <div class="row">
            ...
            <div class="row">
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0"
                                            value=<?php echo "Rp" .   number_format($item["price"], 0,); ?> readonly
                                            id="exampleSelect1">
                                    </div>
                                    <div class="col-xs-4">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check"
                                    class="btn btn-danger btn-lg disabled " style="border-radius: 5px;">Checkout</a>
                                <?php
                                } else {
                                ?>
                                <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check"
                                    class="btn btn-success btn-lg active" style="border-radius: 5px;">Checkout</a>
                                <?php
                                }
                                ?>
                            </div>
                ...
                <div class="col-md-8">
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                Product <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2"
                                    aria-expanded="true">
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        <span
                                            class="price pull-left"><?php echo "Rp" .   number_format($product['price'], 0,); ?></span>
