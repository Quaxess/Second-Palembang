...
<body>
    <div style="background:#F2F1EB;background-image: url(images/bgregis2.gif), url(images/bgregis3.gif);
background-repeat: no-repeat, space;
background-position:0px 190px , 105% 180px">
            ...
            <section class="contact-page inner-page">
                <div class="container ">
                    <div class="row ">
                        <div class="col-md-12">
                            <div class="widget">
                                <div class="widget-body" style="background-color: #fff;border-radius: 10px;">

                                    <form action="" method="post">
                                        <div class="row">
                                            <label class="col-sm-12"
                                                style="text-align: center; font-weight: 500; font-size: 24px">Registration</label>
                                        ...
                                        <div class="row">
                                            <div style="text-align: center ;">
                                                <p> <input type="submit" value="Register" name="submit" class="btn"
                                                        style="background-color: #AFC8AD; color: white;  border-radius: 5px;">
                                                </p>
                                            </div>
                                        </div>
                                    </form>
