...
<body>
    ...
    <div class="page-wrapper">
        ...
        <label class="col-sm-12" style="padding-top: 24px; text-align: center; font-weight: 500; font-size: 2rem;">My
            Orders</label>
    </div>
    <section class="restaurants-page" style="
    padding-top: 89px;
    padding-bottom: 0px;
                    ...
                    <div class="bg-gray">
                        <div class="row">
                            ...
                            <table class="table table-bordered table-hover">
                                <thead style="background: #88AB8E; color:white;">
                                    <tr>
                                    ...
                                    <?php
                                        ...
                                        if (!mysqli_num_rows($query_res) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_array($query_res)) {
                                                ...
                                                $totalSemua = $harga * $quantity + $ongkir;
                                        ?>

                                    <tr>
                                        <td data-column="Item"> <?php echo $row['title']; ?></td>
                                        <td data-column="Quantity"> <?php echo $row['quantity']; ?></td>
                                        <td data-column="price"><?php echo "Rp" .   number_format($row["price"], 0,); ?>
                                        <td data-column="price"><?php echo "Rp" .   number_format($totalSemua, 0,); ?>
                                        </td>
