                                    ...
                                    <div class="col-sm-12">
                                        <div class="cart-totals margin-b-20">
                                            ...
                                            <?php
                                                ...
                                                $jumlahproduk = $item_total + $ongkirtotal;
                                                ?>
                                            <div class="cart-totals-fields">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>Cart Subtotal</td>
                                                            <td> <?php echo "Rp" .   number_format($item_total, 0,); ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-color"><strong>
                                                                    <?php echo "Rp" .   number_format($jumlahproduk, 0,); ?></strong>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="payment-option">
                                            <ul class=" list-unstyled">
                                                ...
                                                <li>
                                                    <label class="custom-control custom-radio  m-b-10">
                                                        <input name="mod" type="radio" value="paypal" checked
                                                            class="custom-control-input"><span
                                                            class="custom-control-indicator"></span> <span
                                                            class="custom-control-description">E-Wallet <img
                                                                src="images/bayar.png" alt="" width="90"></span>
                                                    </label>
                                                </li>
                                            </ul>
                                            <p class="text-xs-center"> <input type="submit"
                                                    ...
                                                    style="border-radius: 5px;" value="Order Now">
                                            </p>
                                        </div>
                            </form>
                        </div>
